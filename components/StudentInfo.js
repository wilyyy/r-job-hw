...
export default function StudentInfo({ data }) {
   ...
   //Add tag to student info, it is called in <TextInput /> below
   /*
   This function add an array of strings to the persisting tags state,
   using data.id to make the tags added unique to its associated component
   */
